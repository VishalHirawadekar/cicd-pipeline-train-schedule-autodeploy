...
//         }
        stage('CanaryDeploy') {
            ...
            steps {
                script {
                    ...
                    config[1].spec.template.spec.containers[0].image = env.DOCKER_IMAGE_NAME:env.BUILD_NUMBER
        ...
        stage('DeployToProduction') {
            ...
            script {
                ...
                configProd[1].spec.template.spec.containers[0].image = env.DOCKER_IMAGE_NAME:env.BUILD_NUMBER
